/* PGG Moderator App - Service Worker
 ...
 */
const CACHE = 'pgg-moderator-cache';
const PREFIX = 'pgg-moderator-';        // only this app's caches are cleaned up
...
// (so it doesn't delete the field / survey caches on the same origin).
